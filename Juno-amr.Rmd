...
The Juno Antimicrobial Resistance(Juno AMR) pipeline is a pipeline that is used to automate
multiple Antiomicrobial Resistance related tools. The tools help identify: acquired
antimicrobial resistance genes, chromosomal mutations mediating antimicrobial resistance,
virulence factors, biocide, heat, acid, and metal resistance genes. The tool takes paired-end
.fastq files or .fasta files as input. The input files can contain full or partial sequences. The
output can be used in antimicrobial resistance analysis and is combined in summary files for
a quick overview of the most important results.
...
* **[VirulenceFinder](https://bitbucket.org/genomicepidemiology/virulencefinder/src/master/)** is a tool that identifies virulence genes in total or partial sequenced isolates of certain bacteria. The tool is created by [The Center For Genomic Epidemiology](https://www.genomicepidemiology.org/).

* **[AMRFinderPlus](https://github.com/ncbi/amr)** is a tool that is used to identify acquired antimicrobial resistance genes and point mutations in protein or assembled nucleotide sequences. In addition to that the tool also identifies other classes of genes such as virulence factors, biocide, heat, acid, and metal resistance genes. The tools is created by [The National Center for Biotechnology Information](https://www.ncbi.nlm.nih.gov/)
...
**Note:** To show a list of the available species for PointFinder use this command in the terminal.
```{}
