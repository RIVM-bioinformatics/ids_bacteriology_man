...
2. [Download](https://github.com/RIVM-bioinformatics/Juno-annotation) the pipeline again and start from the beginning of this [handbook](#juno-annotation). Sometimes there is an issue that has been resolved in newer versions of the pipeline.
