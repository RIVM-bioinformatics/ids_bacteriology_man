...
2. [Download](https://gitl01-int-p.rivm.nl/hernanda/triumph_dada2_run_pipeline) the pipeline again and start from the beginning of this [handbook](#triumph_run). Sometimes there is an issue that has been resolved in newer versions of the pipeline.
